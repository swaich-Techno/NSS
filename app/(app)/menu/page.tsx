...
const copy = {
  en: {
    eyebrow: "Sales",
    title: "Menu",
    description: "Live menu catalogue for billing. Add products with menu category and item code, then pull them into invoices by code.",
    ...
    emptyDescription: "Products are intentionally empty. Add real sweets, snacks, dairy items, and item codes before invoicing."
  },
  pa: {
    eyebrow: "ਵਿਕਰੀ",
    title: "ਮੇਨੂ",
