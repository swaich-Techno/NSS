...
- Product catalogue with menu category, item code/SKU, unit, prices, tax, image URL, and low-stock fields
- Invoice system with menu category filtering, item-code lookup, customer dues, payment status, PDF route, exports, and ledger integration
