...
export function MilkCollectionForm({ farmers }: { farmers: FarmerProfile[] }) {
    ...
    <form action={createModuleRecordAction} className="grid gap-5 rounded-lg border border-border bg-white p-5 shadow-soft">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <div>
          ...
          <select id="farmerId" name="farmerId" required className="mt-2 flex h-10 w-full rounded-md border border-input bg-white px-3 py-2 text-sm shadow-sm outline-none transition focus:border-primary focus:ring-2 focus:ring-ring/20">
