...
function statusTone(value: unknown) {
  ...
  if (["partial", "low", "pending", "warning"].some((word) => normalized.includes(word))) return "warning";
  if (["unpaid", "inactive", "cancelled", "out", "deleted"].includes(normalized)) return "danger";
  return "muted";
}
