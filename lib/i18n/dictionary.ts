...
const common = {
  en: {
    ...
    logout: "Logout",
    language: "Language",
    demoUsers: "Role logins",
    email: "Email",
    password: "Password",
    signIn: "Sign in",
    signingIn: "Signing in...",
    seededAccountHelp: "Use a seeded demo account or production account after database setup.",
  ...
  pa: {
    ...
    seededAccountHelp: "ਡਾਟਾਬੇਸ ਸੈਟਅੱਪ ਤੋਂ ਬਾਅਦ ਡੈਮੋ ਜਾਂ ਪ੍ਰੋਡਕਸ਼ਨ ਖਾਤਾ ਵਰਤੋ।",
